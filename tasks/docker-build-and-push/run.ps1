...
cp repo/2019/UserRights.psm1 builddir\
...
Run-Docker "--version"
Run-Docker "build", "-t", "${env:IMAGE_NAME}:with-interactive-services-11", "--pull", "."
...
Run-Docker "push", "${env:IMAGE_NAME}:with-interactive-services-11"
